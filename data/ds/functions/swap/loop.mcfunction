...
execute if score period internal matches 1 as @r[tag=!swapped,gamemode=!spectator] at @s if score swap internal matches 1.. if score swap_players internal matches 2.. run function ds:swap/all
